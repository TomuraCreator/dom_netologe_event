[![Build status](https://ci.appveyor.com/api/projects/status/3qxbtrk4gmlupgod/branch/master?svg=true)](https://ci.appveyor.com/project/Tryd0g0lik/dom-netologe-event/branch/master)
...
Сделайте так, чтобы гоблин исчезал при клике и появлялся в другом месте через заданный интервал. Т.е. удалить гоблина из ячейки недостаточно, нужно ещё перезапустить таймаут или интервал
